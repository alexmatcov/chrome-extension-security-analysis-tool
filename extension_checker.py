...
a single JSON file called "all_extensions_risk_analysis.json".
"""
...
def check_risk_analysis_file(suspicious_ids, file_path="all_extensions_risk_analysis.json"):
...
def main():
    ...
    # Ask for file path
    file_path = input("Enter path to 'all_extensions_risk_analysis.json' (or press Enter for current directory): ").strip()
    if not file_path:
        file_path = "all_extensions_risk_analysis.json"
