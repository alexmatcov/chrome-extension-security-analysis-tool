...
def analyze_extensions_directory(
    directory_path: str, 
    all_output_file: str = "all_extensions_paper_methodology.json", 
    top_k_output_file: str = "top_10k_risky_extensions_paper_methodology.json", 
    top_k: int = 10000
...
if __name__ == "__main__":
    ...
    all_extensions, top_10k_extensions = analyze_extensions_directory(
        ...
        all_output_file="all_extensions_paper_methodology.json",
        top_k_output_file="top_10k_risky_extensions_paper_methodology.json",
        top_k=10000
    )
